...
# manually code as missing so we can add if they dont appear in the dataset
...
index_acs_main |>
  dplyr::count(fudge_cambridge_segment, procedure) |>
  dplyr::group_by(fudge_cambridge_segment) |>
  dplyr::mutate(pct = prop.table(n) * 100) |>
  ggplot(aes(fudge_cambridge_segment, n, fill=procedure)) +
  geom_bar(stat="identity") +
  ylab("Number of patients") +
  geom_text(aes(label=paste0(sprintf("%1.1f", pct),"%")),
            position=position_stack(vjust=0.5)) +
  ggtitle("Procedure breakdown")
