...
icd10_codes_fp <- system.file("icd10_codes/cabg_lipids_cohort_codes.csv", package="acsprojectns")
opcs_codes_fp  <- system.file("icd10_codes/cabg_lipids_cohort_codes.csv", package="acsprojectns")
...
index_procedures <- msrv$sus$apc_spells_procedure |>
  ...
  pivot_longer(matches("procedure_[0-9]+_opcs"), 
               ...
               values_drop_na=TRUE) |>
  left_join(icd10_opcs_codes, by=c("index_procedure_code"="code")) |>
  filter(!is.na(group), group!="stroke_tia") |> # hack, as G459 OPCS is also the TIA ICD code...
