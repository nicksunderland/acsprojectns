...
surf_data <- acsprojectns::create_survival_timings(all_subsequent_events, outcome_groupings) |> 
  ...
  dplyr::group_by(nhs_number) |>
  dplyr::mutate(chol_control = dplyr::if_else(rep(any(chol_control=="blanking_window"), dplyr::n()), "blanking_window", chol_control), 
                chol_control = factor(chol_control, levels=c("blanking_window", "not measured", levels(cholesterol_control$chol_control))))
