...
foo <- readr:: read_csv("/Users/nicholassunderland/Documents/2.Medical_work/5.Bristol/acsprojectns/acsprojectns/materials/dummy_databases/swd_activity_dummy_database.csv")
