...
db_connection <- dbConnect(MySQL(),
                           ...
                           dbname="TEST_RESULTS", host="localhost")

# Load some dummy data
# must ensure date formatting yyyy-mm-dd in the .csv !!!!!
foo <- readr:: read_csv("/Users/nicholassunderland/Documents/2.Medical_work/5.Bristol/acsprojectns/acsprojectns/materials/dummy_databases/blood_tests_dummy_database.csv")
